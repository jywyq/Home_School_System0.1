...
<form action="#" method="post">
	<table class="table table-bordered table-hover definewidth m10"
		...
		<tr>
			...
			<td><input type="text" name="bigTypeName"
				style="height: 41px; width: 546px" /></td>

		</tr>
		<tr>
			<td class="tableleft">内容</td>
			<td><input type="text" name="typeIntroduce"
		...
		<tr>
			...
			<td style="height: 46px;">
				<div style="margin: 0 auto;">
					<input type="text" id="time1" value="选择时间"
						onClick="return Calendar('time1');" class="text_time" />
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<div style="margin: 0 auto;">
					<input type="text" id="time2" value="选择时间"
						onClick="return Calendar('time2');" class="text_time" />
				</div>
			</td>
		</tr>
		<tr>
