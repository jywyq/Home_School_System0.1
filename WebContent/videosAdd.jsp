	...
	<form action="#" method="post" class="definewidth m20"
		...
		<table class="table table-bordered table-hover m10"
			...
			<tr>
				...
				<td><select name="bigTypeId">
						<option value="0">大类</option>
						<option value='1' />&nbsp;教育
						</option>
            <option value='7' />&nbsp;娱乐</option>
            </select> <select name="smallTypeId">
			...
			<tr>
				...
				<td class="tableleft" style="width: 196px;"><input type="file"
					name="GoodsPicture" id="GoodsPicture" multiple="multiple" />
				<td>
					<!--         <td class="tableleft">图片预览</td> --> <!--         <td><img name="showimg" id="showimg" src="" style="display:none;" alt="预览图片" /> </td> -->
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="GoodsIntroduce"
