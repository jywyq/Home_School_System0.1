<%@ page language="java" import="hibernate.EN" contentType="text/html; charset=gb2312"
	pageEncoding="gb2312"%>
<%
...
<form action="UpdateNServlet" method="post" class="mian_b"
		id="myform">
...
<tr>
<td>&nbsp;</td>
<td width="10%" valign="top">公告编号：</td>
<td width="55%">
<input type="text" class="input_01" name="nid" id="nid" value=${ad.nid } readonly="readonly"> </td>
<td width="35%">&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<td width="55%">
<input type="text" class="input_01" name="title" id="textfield" value=${ad.title }> </td>
<td width="35%">&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
...
<td>
<textarea type="text" name="txt" id="text1" >${ad.txt }</textarea>
</td>
<td>&nbsp;</td>
</tr>
<tr>
