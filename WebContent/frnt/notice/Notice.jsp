...
操作
	...
	<c:forEach var="list" items="${list}">
		<tr>
			...
			<td>${list.txt }</td>
			<td width="5%"><div class="mian_b_icon_04"><a href="QueryNoticeById?nid=${list.nid }">修改</a></div></td>
			<td width="5%"><div class="mian_b_icon_04"><a href="NoticeShowDetailById?nid=${list.nid }">查看</a></div></td>
			<td width="5%"><div class="mian_b_icon_04"><a href="DeleteNoticeById?nid=${list.nid }">删除</a></div></td>
		</tr>
	</c:forEach>
