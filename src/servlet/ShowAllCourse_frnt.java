...
import hibernate.EC;
public class ShowAllCourse_frnt extends HttpServlet {
	public ShowAllCourse_frnt() {
		super();
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("frnt/teacher_class/QueryCourseById.jsp").forward(request, response);// 转发到现实全部的页面
		out.flush();
		out.close();
	}
