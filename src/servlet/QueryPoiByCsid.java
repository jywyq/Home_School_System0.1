...
public class QueryPoiByCsid extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "select * from r_studentclass natural join r_teach natural join e_s natural join e_c where csid="+csid;
